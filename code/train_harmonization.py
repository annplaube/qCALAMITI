...
def main(args=None):
    ...
    parser = argparse.ArgumentParser(description='qCALAMITI: unsupervised MR harmonization for qMRI')
    ...
    # initialize model
    trainer = qCALAMITI(beta_dim = args.beta_dim,
    ...
    results_dir = os.path.join(args.out_dir, f"results_{run_id}") 
    trainer.initialize_training(out_dir=results_dir, lr=args.lr)
